...
const LANGS = {
  fr: {
    ...
    notif_nearby_title: 'Une présence tout près de vous',
    notif_nearby_sw_title: 'Une trace vous attend',
  ...
  en: {
    ...
    // Notifications
    notif_new_ghost_title: 'A ghost has drawn near',
    ...
    notif_nearby_title: 'A presence very close to you',
    notif_nearby_sw_title: 'A trace is waiting for you',
